document.addEventListener("DOMContentLoaded", function () {
  const data = [
    ...
    { no: 60, nama: "Navela Dwita", jabatan: "Sub Divisi Syuro" },
    { no: 61, nama: "Sabrina Anggraeni", jabatan: "Sub Divisi Syuro" },
    { no: 62, nama: "Ananda Putra", jabatan: "Sub Divisi Wawancara" },
    { no: 63, nama: "(Ikhwan)", jabatan: "Sub Divisi Wawancara" },
    { no: 64, nama: "(Ikhwan)", jabatan: "Sub Divisi Wawancara" },
    { no: 65, nama: "(Ikhwan)", jabatan: "Sub Divisi Wawancara" },
    { no: 66, nama: "(Ikhwan)", jabatan: "Sub Divisi Wawancara" },
    { no: 67, nama: "Natha Mariza", jabatan: "Sub Divisi Wawancara" },
    { no: 68, nama: "Jihan Rahima", jabatan: "Sub Divisi Wawancara" },
    { no: 69, nama: "Aisyah Haura", jabatan: "Sub Divisi Wawancara" },
    { no: 70, nama: "Humairoh", jabatan: "Sub Divisi Wawancara" },
    { no: 71, nama: "Ika Wulandari", jabatan: "Sub Divisi Wawancara" },
  ];
